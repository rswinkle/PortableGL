...
void mb_smooth_vs(float* vs_output, void* vertex_attribs, Shader_Builtins* builtins, void* uniforms)
{
...
void mb_smooth_fs(float* fs_input, Shader_Builtins* builtins, void* uniforms)
{
	builtins->gl_FragColor = ((vec4*)fs_input)[0];
}

void mapped_vbuffer(int argc, char** argv, void* data)
{
	...
	GLuint myshader = pglCreateProgram(mb_smooth_vs, mb_smooth_fs, 4, smooth, GL_FALSE);
