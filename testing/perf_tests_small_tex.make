...
RESCOMP = windres
TARGETDIR = .
TARGET = $(TARGETDIR)/perf_tests_small_tex
...
ifeq ($(config),debug)
OBJDIR = obj/Debug/perf_tests_small_tex
DEFINES += -DDEBUG -DUSING_PORTABLEGL -DTEX_PATH=\"../media/textures/star.gif\"
...
OBJDIR = obj/Release/perf_tests_small_tex
DEFINES += -DNDEBUG -DPGL_UNSAFE -DUSING_PORTABLEGL -DTEX_PATH=\"../media/textures/star.gif\"
...
$(TARGET): $(GENERATED) $(OBJECTS) $(LDDEPS) | $(TARGETDIR)
	$(PRELINKCMDS)
	@echo Linking perf_tests_small_tex
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning perf_tests_small_tex
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
