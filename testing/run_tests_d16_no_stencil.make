...
RESCOMP = windres
TARGETDIR = .
TARGET = $(TARGETDIR)/run_tests_d16_no_stencil
...
ifeq ($(config),debug)
OBJDIR = obj/Debug/run_tests_d16_no_stencil
DEFINES += -DDEBUG -DUSING_PORTABLEGL -DPGL_D16 -DPGL_NO_STENCIL
...
OBJDIR = obj/Release/run_tests_d16_no_stencil
DEFINES += -DNDEBUG -DPGL_UNSAFE -DUSING_PORTABLEGL -DPGL_D16 -DPGL_NO_STENCIL
...
$(TARGET): $(GENERATED) $(OBJECTS) $(LDDEPS) | $(TARGETDIR)
	$(PRELINKCMDS)
	@echo Linking run_tests_d16_no_stencil
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning run_tests_d16_no_stencil
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
