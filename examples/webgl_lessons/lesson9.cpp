...
int main(int argc, char** argv)
{
	...
	if (!load_texture2D("../../media/textures/star.gif", GL_LINEAR, GL_LINEAR, GL_REPEAT, GL_TRUE, GL_FALSE, NULL, NULL)) {
	...
	while (handle_events()) {
		...
		if (nk_begin(ctx, "Controls", nk_rect(WIDTH-GUI_W, 0, GUI_W, 80),
