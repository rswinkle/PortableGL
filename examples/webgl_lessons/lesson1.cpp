...
void white_fs(float* fs_input, Shader_Builtins* builtins, void* uniforms);
...
int main(int argc, char** argv)
{
	...
	GLuint program = pglCreateProgram(basic_transform_vs, white_fs, 0, NULL, GL_FALSE);
...
void white_fs(float* fs_input, Shader_Builtins* builtins, void* uniforms)
{
	*(vec4*)&builtins->gl_FragColor = vec4(1);
}
