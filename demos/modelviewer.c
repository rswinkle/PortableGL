...
int main(int argc, char** argv)
{
	...
	while (1) {
		...
		SDL_UpdateTexture(texture, NULL, bbufpix, WIDTH * sizeof(pix_t));
		//Render the scene
...
void setup_context(void)
{
	...
	texture = SDL_CreateTexture(ren, SDL_PIXELFORMAT_ABGR8888, SDL_TEXTUREACCESS_STREAMING, WIDTH, HEIGHT);
